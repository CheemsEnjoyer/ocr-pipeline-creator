...
export default function EditPipelinePage({ params }) {
  ...
  if (!pipeline) return <main className="app-shell"><Header subtitle="Редактирование пайплайна"/><div className="history-empty"><h1>Пайплайн не найден</h1><p>Возможно, он был удалён или сохранён в другом браузере.</p><Button asChild><Link href="/">Создать пайплайн</Link></Button></div></main>;
