...
function StepOcr({ temperature, setTemperature, sourceType, ocrMode, setOcrMode, ocrModel, setOcrModel, ocrServiceUrl, setOcrServiceUrl, visionPrompt, setVisionPrompt, skipExtraction, setSkipExtraction, models, modelsLoading, modelError }) {
