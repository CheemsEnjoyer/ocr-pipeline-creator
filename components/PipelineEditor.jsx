...
function StepExtraction({ promptAllowed, temperature, setTemperature, promptEnabled, setPromptEnabled, fieldsEnabled, setFieldsEnabled, prompt, setPrompt, fields, setFields, addField, llmModel, setLlmModel, maxTokens, setMaxTokens, models, modelsLoading, modelError }) {
